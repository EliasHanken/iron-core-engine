...
int main() {
    ...
    app.setRender([&]() {
        ...
        // Each rigid body draws as a colored unit cube scaled to its halfExtents.
        ...
        submitBox(iron::translation({0.0f, -0.5f, 0.0f}), {25.0f, 0.5f, 25.0f}, {0.30f, 0.30f, 0.30f});
        submitBox(iron::translation({-5.0f, 1.0f, 5.0f}), {1.5f, 0.05f, 0.5f}, {0.65f, 0.50f, 0.30f});
        submitBox(iron::translation({ 0.0f, 1.5f, 5.0f}), {1.5f, 0.05f, 0.5f}, {0.65f, 0.50f, 0.30f});
        submitBox(iron::translation({+5.0f, 2.0f, 5.0f}), {1.5f, 0.05f, 0.5f}, {0.65f, 0.50f, 0.30f});
        submitBox(iron::translation({ 0.0f, 0.5f, -3.0f}), {2.0f, 0.5f, 0.1f}, {0.45f, 0.45f, 0.55f});
